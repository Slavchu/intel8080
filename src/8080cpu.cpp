...
struct opcode_info_t{
  ...
  uint8_t tick_required_alt=0;    //some instruction can take different amount of cpu cycles depended on conditions
};

//opcode info section
static opcode_info_t op_info[NUM_INSTRUCTIONS] = {
    {0, 4},  // 0x00 NOP
    {2, 10}, // 0x01 LXI B, d16
    {0, 7},  // 0x02 STAX B
    {0, 5},  // 0x03 INX B
...
int CPU_8080::process_opcode(uint8_t opcode){
  ...
  return op_info[opcode].tick_required;
}
